    ...
    >
      ...
      >
        <div className="fixed inset-0 z-[200] bg-black/70 backdrop-blur-md flex items-center justify-center">
          <div className="w-full max-w-4xl h-[85vh] rounded-3xl bg-gradient-to-br from-[#3A2A4F] to-[#24192F] border border-white/10 shadow-2xl flex flex-col">
            {/* Header */}
            ...
            <div className="flex-1 px-6 py-6 space-y-4 overflow-y-auto">
              ...
              {[
                ...
                <button
                  key={text}
                  className="w-full text-left px-4 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white/80 transition-colors"
                >
                  {text}
                </button>
              ))}
